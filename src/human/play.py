...
from src.environment.visual.chessman import *
...
class PlayWithHuman:
    ...
    def init_screen(self):
        ...
        self.creat_sprite_group(self.chessmans, self.env.board.chessmans_hash, self.chessman_w, self.chessman_h)
    ...
    def ai_move(self):
        ...
        while not self.env.done:
            if ai_move_first == self.env.red_to_move:
                ...
                chessman_sprite = self.select_sprite_from_group(self.chessmans, x0, y0)
                sprite_dest = self.select_sprite_from_group(self.chessmans, x1, y1)
                if sprite_dest:
